...
import { buildOutput, epOutput, epPackage, projRoot } from '@cjx-low-code/build-utils'
...
export const copyTypesDefinitions: TaskFunction = (done) => {
  ...
  const copyTypes = (module: Module) =>
    withTaskName(`copyTypes:${module}`, async () => {
      const dest = buildConfig[module].output.path
      return copy(src, dest, { recursive: true })
    })
