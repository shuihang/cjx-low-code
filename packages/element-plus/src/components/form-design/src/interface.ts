import { booleanType, objectType, stringType } from '@cjx-low-code/shared'
import type {
  CascaderInstance,
  CascaderProps,
  CheckboxProps,
...
export type BaseField<F extends object = FormModelValueType> = Omit<FormColumnProps<F>, 'type'>

export interface NormalField<F extends object = FormModelValueType> extends BaseField<F> {
  type: FormItemType
}

export type SchemaProvide<F extends object = FormModelValueType> = NormalField<F>

export type SchemaItem<F extends object = FormModelValueType> = NormalField<F>

export type SchemaItemArray<F extends object = FormModelValueType> = Array<SchemaItem<F>>
...
> & {
  ...
  collapseShow?: boolean | ((props: { form: F; schemaField: any }) => boolean)
  // /** 内容提示辅助语 */
  // tip?: string | VNode
  // /** 内容提示辅助语位置 */
   ...
   */
  display?: boolean | ((props: { form: F; schemaField: any }) => boolean)
  /**
   ...
   **/
  disabled?: boolean | ((props: { form: F; schemaField: any }) => boolean)
  /**
   * 表单项的事件处理器配置
...
export type GroupInterface<F extends object = FormModelValueType> = {
   ...
   * @returns {boolean} 是否显示
   */
  display?: (props: { form: F; schemaField: any }) => boolean
}
