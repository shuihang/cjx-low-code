import { isString } from '@cjx-low-code/shared'
...
export const errorMessages: Record<ErrorCodes, string> = {
  ...
  [ErrorCodes.THE_OPTION_PARAMETER_OF_CRUD_COMPONENTS_IS_MANDATORY]:
    'The option parameter of CRUD components is mandatory',
  [ErrorCodes.WHEN_USING_THE_CRUD_COMPONENT_TO_ADD_AND_EDITING_FUNCTIONS_THE_FORM_PARAMETER_IS_REQUIRED_TO_BE_PASSED]:
    'When using the CRUD component to add, and edit functions, the form parameter must be passed',
