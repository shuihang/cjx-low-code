...
import { arrayType, booleanType, objectType, stringType } from '@cjx-low-code/shared'
import { useLocale } from '../../../hooks'
import type { Component, ComputedRef, ExtractPropTypes, UnwrapRef } from 'vue'
import type { FormItemRule } from 'element-plus'
import type { FormTypeProps } from '../../form-design/src/interface'
import type { ColumnProps, Placement } from '../../crud/src/interface'
...
type EditTableComponents = Pick<
  FormTypeProps,
  'input' | 'select' | 'inputNumber' | 'textarea' | 'radio' | 'datePicker'
>
