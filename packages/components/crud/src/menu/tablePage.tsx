...
const { pageLayout, pagerCount, pageSizes, pageBackground } = crudConfig
        ...
        {slots.default?.() ||
          ((props.page.total || 0) > 0 && (
            <ElPagination
              ...
              layout={props.page?.layout?.join(',') || pageLayout.join(',')}
              background={props.page.background || pageBackground}
              pageSizes={props.page.pageSizes || pageSizes}
              total={props.page.total}
              pagerCount={props.page?.pagerCount || pagerCount}
