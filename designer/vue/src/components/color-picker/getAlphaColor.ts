...
export const getRgbColor = (baseColor: string) => new TinyColor(baseColor).toRgbString()
...
function getAlphaFrontBgColor(frontColor: string, backgroundColor: string): string {
...
export default getAlphaFrontBgColor
