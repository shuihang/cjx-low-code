import {
  ...
  ElUpload,
  provideGlobalConfig
} from "./chunk-JOJZ274X.js";
import "./chunk-TDJFVP5C.js";
...
var XHeaderMenu = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return !props.title && !(addBtn && (permission == null ? void 0 : permission.addBtn)) && !(importBtn && (permission == null ? void 0 : permission.importBtn)) && !(excelBtn && (permission == null ? void 0 : permission.exportBtn)) && !menuHeaderRight && !slots.default ? createVNode("template", null, null) : createVNode("div", {
